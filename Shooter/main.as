...
class Bullet
{
	...
	void SpawnNewPlayerBullet()
	{
		...
		BulletImg2.SetPosition(Vec3F((playerPosition.x + (Player1.Width / 2) )+ cos(playerRotation.z), (playerPosition.y + (Player1.Height / 2)) + sin(playerRotation.z), 0));		
		...
		AudioManager::PlayAudio("asset:Audio\\gun-sound.mp3", false);
	}
...
void InitialiseGame()
{
	...
	AudioManager::PlayAudio("asset:Audio\\Elwood - Dead lock.mp3", true);
